...
Inter = compound_random_normal_features(150,225,R,E)
plot(Inter,legend=false)
predict([5000],[8000],1e-3,1e-5,Inter,E,F,viz=true)

# Compounded sampled projection
Inter = compound_sampled_features(100,225,R,E)
plot(Inter,legend=false)
...
plot(Inter,legend=false)
predict([5000],[8000],1e-4,1e-4,Inter,E,F)
